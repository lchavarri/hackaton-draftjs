...
class MediaEditorExample extends React.Component<any, IState> {
  focus: () => any;
  logState: () => void;
  ...
  _promptForMedia(type) {
    this.setState(
      ...
      () => {
        setTimeout(() => (this.refs.url as any).focus(), 0);
      }
    );
  }
  _addAudio() {
...
const Audio = props => {
  return <audio controls src={props.src} style={styles.media as any} />;
};
const Image = props => {
  return <img src={props.src} style={styles.media as any} />;
};
const Video = props => {
  return <video controls src={props.src} style={styles.media as any} />;
};
const Media = props => {
